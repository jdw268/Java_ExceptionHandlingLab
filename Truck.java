...
public class Truck extends Vehicle{
	...
	public int getBedSize() throws TruckOptionsException{
		...
		try{
			...
			throw new TruckOptionsException(customOption, this.getOptionsList(locationTruck, locationTruck + 5));
		}
	...
	//getter for engine
	public int getEngine() throws TruckOptionsException{
		//get customOption by calling readModelName (since model name is already set)
		String customOption = readModelName();
		Boolean continueRead = true;  //used to search configFile
		int counter = 0;  //count through configFile
