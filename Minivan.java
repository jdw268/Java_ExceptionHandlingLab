...
public class Minivan extends Vehicle{
	...
	public Minivan(String makeInput, FileReader configInput, String pidNumber){
		...
		catch(MinivanOptionsException e){
	...
	//getter for seats
	public int getSeats() throws MinivanOptionsException{
		...
		for(int i = counter; i <= (counter+4); i++){
			...
			if ((i == counter + 4) && (seatsString.equalsIgnoreCase(null))){
				//throw SedanOptionExceptoin
				throw new MinivanOptionsException(customOption, this.getOptionsList(locationVan, (locationVan + 5)));
			}
		} //end for
